...
<?php $url = ($poster_link['which'] === '1') ? 'https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz='.$poster_link['weixin'].'==#wechat_redirect' : 'http://'. $poster_link['link']; ?>
...
<!--    </div>-->
    <img id="a" src="<?php echo $poster['img'];?>" style="display: block;width: 100%;margin:auto;">
</a>
